...
class _AppServiceClient implements AppServiceClient {
  ...
  Future<RegisterAuthResponse> register(
    ...
    final _options = _setStreamType<RegisterAuthResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RegisterAuthResponse _value;
    try {
      _value = RegisterAuthResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<PaginatedMoviesResponse> getPaginatedMovies(
    ...
    final _options = _setStreamType<PaginatedMoviesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<GetCommentResponse> getComments(String movieId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetCommentResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
